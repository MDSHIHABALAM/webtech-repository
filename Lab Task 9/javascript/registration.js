function validregistration(reg) {
    ...
    if (dob == "") {
        ...
        isvalid = false;
    } else if ((currdate.getFullYear() - date.getFullYear()) < 10) {
        dobErr.innerHTML = "Not old enough, Must be 10 or older.";
        isvalid = false;
    }
    ...
    if (username == "") {
        ...
        userErr.innerHTML = "Username up to 10 characters long.";
        isvalid = false;
    }
...
function validteacher(reg) {
    ...
    else if((currdate.getFullYear()-date.getFullYear()) < 16) {
        dobErr.innerHTML = "Not old enough, Must be 16 or older.";
        isvalid = false;
    }
